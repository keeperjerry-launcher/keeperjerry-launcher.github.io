...
```
:::
::: code-group-item Публичный домен
```bash
...
:::: code-group
::: code-group-item Основное зеркало
```bash
mirrors: [
...
```
:::
::: code-group-item Основное с дополнительным
```bash
mirrors: [
...
```
:::
::: code-group-item Дополнительное в приоритете
```bash
mirrors: [
